PK(Primary Key) : 테이블의 레코드를 구분할 수 있는 최소의 컬럼(UNIQUE, NOT NULL) --반드시 값이 있어야 한다!!
...
--                                   ￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣
SELECT 학번, 이름, 주소, 학생테이블.(점!은 접근연산자!'의')학과번호, 학과명
FROM    학생테이블, 학과테이블                        --컴마(,)로 구분하는데 테이블명을 나열한것을 JOIN 이라 함, 조인테이블
WHERE   학생테이블.학과번호 = 학과테이블.학과번호 ;   --조인조건식
